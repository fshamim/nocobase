...
export default defineCollection({
  ...
  fields: [
    ...
    {
      name: 'minimumProjectionCoveredDays',
      type: 'integer',
      interface: 'integer',
      uiSchema: { title: 'Minimum projection covered days' },
      allowNull: false,
      defaultValue: 14,
    },
    {
      name: 'paceTolerancePercent',
      type: 'decimal',
      precision: 30,
      scale: 8,
      interface: 'number',
      uiSchema: { title: 'Pace tolerance percent' },
      allowNull: false,
      defaultValue: 0,
    },
    {
      name: 'projectionPolicyVersion',
      type: 'string',
      interface: 'input',
      uiSchema: { title: 'Projection policy version' },
      allowNull: false,
