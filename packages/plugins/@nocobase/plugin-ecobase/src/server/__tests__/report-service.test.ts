  ...
  it('generates idempotent daily operations brief evidence without secrets', async () => {
    ...
    await db.getRepository(ECOBASE_COLLECTIONS.goldInventoryPlanningRows).create({
      values: {
        ...
        amazonAccountId: 'account-brief-1',
        ...
        calculationEvidence: {
          familyActionSnapshot: {
            familyKey: 'family:company-product-brief-1',
            companyProductFamilyId: 'family:company-product-brief-1',
            companyId: 'company-brief-1',
            amazonAccountId: 'account-brief-1',
            marketplace: 'Amazon.com',
            ...
            targetCompanyProductId: 'company-product-brief-1',
            targetSelectionEvidence: { source: 'report_test' },
          },
        },
      },
    });
