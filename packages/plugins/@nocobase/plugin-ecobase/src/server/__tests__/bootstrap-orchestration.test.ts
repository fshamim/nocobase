...
describe('live-gate import orchestration', () => {
  ...
  it('orders source files and final actions deterministically', () => {
    ...
    const supplierOrderSourceFiles = script.slice(
      script.indexOf('function supplierOrderFiles()'),
      script.indexOf('function clickupFiles()'),
    );
    expect(supplierOrderSourceFiles.indexOf("'Supplier IDs.csv'")).toBeLessThan(
      supplierOrderSourceFiles.indexOf("'Supplier 2026.csv'"),
    );
    expect(supplierOrderSourceFiles.indexOf("'Supplier 2026.csv'")).toBeLessThan(
      supplierOrderSourceFiles.indexOf("'Purchase Orders.csv'"),
    );
    expect(supplierOrderSourceFiles.indexOf("'Purchase Orders.csv'")).toBeLessThan(
      supplierOrderSourceFiles.indexOf("'OrderDetails.csv'"),
    );
