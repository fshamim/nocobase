...
async function seedDashboard(db: MemoryDatabase) {
  ...
  await db.getRepository(ECOBASE_COLLECTIONS.goldInventoryPlanningRows).create({
    values: {
      ...
      planningProductId: 'product-1',
      companyProductId: 'company-product-1',
      companyProductFamilyId: 'family:company-product-1',
      companyId: 'company-1',
      ...
      familyTargetCompanyProductId: 'company-product-1',
      ...
      calculationEvidence: {
        familyActionSnapshot: {
          familyKey: 'family:company-product-1',
          companyProductFamilyId: 'family:company-product-1',
          companyId: 'company-1',
          amazonAccountId: 'account-1',
          marketplace: 'Amazon.com',
          ...
          targetCompanyProductId: 'company-product-1',
