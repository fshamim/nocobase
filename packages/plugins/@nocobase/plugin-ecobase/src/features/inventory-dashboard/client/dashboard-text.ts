...
export const TEXT = {
  ...
  // Order Create/View UI (T4/T5). Reuses existing literals where they exist
  // (Company→companyFilterLabel, Product→colProduct, Order→colOrder,
  // Supplier→drawerSupplier, Save→drawerSave). Marketplace/Units/Complete already
  // ship in the shared locale files.
  ocMarketplace: 'Marketplace',
  ocUnits: 'Units',
  ocComplete: 'Complete',
  ocSectionOrder: 'Order details',
  ocOrderRef: 'Order ref',
  ocRefAvailable: 'Reference available',
  ocRefTaken: 'Reference already used',
  ocRefHint: 'Auto-generated — editable, checked live',
  ocOrderDate: 'Order date',
  ocPlacedBy: 'Placed by',
  ocPaymentPanel: 'Payment & shipping — optional',
  ocPaymentStatus: 'Payment status',
  ...
  ocExpectedSellable: 'Expected sellable',
  ocProductsSection: 'Products',
  ocColQty: 'Qty',
  ocColUnitCost: 'Cost / unit',
  ocColPack: 'Pack',
  ocColSellPrice: 'Sell price',
  ocColMargin: 'Margin',
  ocColTotal: 'Total',
  ocAddProduct: 'Add product',
  ocRemoveLine: 'Remove line',
  ocSearchProduct: 'Search by ASIN, SKU or name',
  ocExpectedCost: 'Expected cost',
  ocSubmit: 'Create draft order',
  ocCancel: 'Cancel',
  ocNeedSupplier: 'Select a supplier first',
  ocNeedLine: 'Add at least one product',
  ocRefRequired: 'Enter an order reference',
  ovEditOrder: 'Edit order',
  ovDelete: 'Delete…',
  ovCancelBtn: 'Cancel…',
  ...
  ovCarrier: 'Carrier',
  ovTrackingShort: 'Tracking',
  ovApproval: 'Approval',
  ovOrderLines: 'Order lines',
  ovAmazonCheck: 'Amazon check',
  ovReceipt: 'Receipt',
  ovActivity: 'Activity',
  ovEditLine: 'Edit line',
  ovDeleteLine: 'Delete line',
  ovPlacedByPrefix: 'placed by',
  ovOrderedPrefix: 'ordered',
  ovSetStatusTitle: 'Set order status',
  ovStageBefore: 'Before ordered',
  ovStageAfter: 'After ordered',
  ovNoActivity: 'No activity yet',
  ovDeleteConfirmManual: 'Delete this order and all its lines?',
  ovDeleteConfirmImported: 'This imported order will be marked cancelled, not deleted.',
  ovDeleteLineConfirm: 'Remove this product from the order?',
  ovStatusUpdated: 'Status updated',
  ovOrderUpdated: 'Order updated',
  ovLineUpdated: 'Line updated',
  ovLineAdded: 'Product added',
  ovLineDeleted: 'Product removed',
  ovOrderDeleted: 'Order deleted',
  ovOrderCancelled: 'Order cancelled',
  ovEditOrderTitle: 'Edit order details',
  ovObserved: 'observed',
  ovAwaitingStock: 'awaiting stock',
  // Order panes shared table (T4). Reuses colOrder / drawerStatus / ocUnits /
  // colLastActivity / metricMoneyAtRisk / bucketFba / ovOrderedPrefix / dSuffix
  // / rel*Ago where those literals already ship.
  opColCost: 'Cost exp → act',
  opColInStatus: 'In status',
  opPillPrep: 'PREP',
  opMileAppr: 'APPR',
  opMileOrder: 'ORDER',
  opMilePay: 'PAY',
  opMileInv: 'INV',
  opMileTransit: 'TRANSIT',
  ...
  opUnitAbbrev: 'u',
  opArrived: 'arrived',
  opNothingMoved: 'nothing moved from ordered to inbound yet',
  opConfirmInboundChip: 'Inbound complete — confirm & move to Healthy',
  opCompleted: 'completed',
  opReasonFollowUp: 'Follow up with supplier',
  opReasonPrepIdle: 'Prep idle',
  opReasonInboundOverdue: 'Inbound overdue — check shipment',
  opReasonPaymentBlocked: 'Payment blocked',
  opOf: 'of',
  opProductsAtRisk: 'products at risk',
  opStockCoversEta: 'stock covers ETA',
  opMinAgo: 'min ago',
  opRowLabel: 'Open order',
  // Order popup — Prep details + paperwork (T5).
  opShippingId: 'Shipping ID',
  opHazmat: 'Hazmat',
  opPrepStatusLabel: 'Prep status',
  opPrepInProgress: 'In progress',
  opPrepCompleted: 'Completed',
  opLength: 'Length',
  opBreadth: 'Breadth',
  opHeight: 'Height',
  opWeight: 'Weight',
  ...
  opYes: 'Yes',
  opNo: 'No',
  opPrepSaved: 'Prep details saved',
  opEditPaperwork: 'Edit paperwork',
  opInvoiceStatus: 'Invoice status',
  opAttachmentRef: 'Attachment reference',
  opPaperworkSaved: 'Paperwork updated',
  opConfirmInboundTitle: 'Confirm inbound complete?',
